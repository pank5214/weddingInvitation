...
import groom from "../images/pankaj.jpg";
import bride from "../images/IMG-20240520-WA0011.jpg";
const Invitation = () => {
  return (
            ...
            <div className="couple-wrap">
              ...
              <div className="couple-half bride-half">
                ...
                <div className="desc-bride">
                  <h3>Shreya Bharati</h3>
                  <h5>D/O Nageshwar Prasad</h5>
                  <h5>Bharati Devi</h5>
                </div>
              </div>
            </div>
